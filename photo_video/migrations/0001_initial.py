    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(default='dfdsfd', unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(default='fff', unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='videos', to='photo_video.videocategory', verbose_name='Раздел видеоальбома')),
            ],
        ),
        migrations.CreateModel(
            name='PhotoLibrary',
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='photos', to='photo_video.photocategory', verbose_name='Раздел фотоальбома')),
            ],
            options={
