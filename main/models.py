...
class Service(models.Model):
    ...
    price_with_VTA = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="Тариф с НДС")
    price_without_VTA = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="Тариф без НДС")
